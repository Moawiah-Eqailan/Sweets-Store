    ...
    <div class="create-product-container">
        <div class="form-card">
            <div class="form-header">
                ...
                <p class="form-subtitle">أضف منتجًا جديدًا إلى الكتالوج الخاص بك</p>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="product_price" class="form-control"
                                placeholder="Enter offers price..." value="{{ old('product_price') }}" min="0"
                                step="0.01">
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-wrapper">
                        <div class="file-upload-preview" id="imagePreview">
                            ...
                            <p class="upload-text">انقر أو اسحب الصورة لتحميلها</p>
                        </div>
