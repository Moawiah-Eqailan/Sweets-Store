                ...
                <div class="header-actions">
                    <form class="search-form" method="GET" action="{{ route('ssearchh') }}">
                        <div class="search-wrapper">
                            <input type="text" name="query" class="search-input" placeholder="ابحث بالاسم">
                    ...
                    <!-- <a href="{{ route('Users.create') }}" class="add-button">
                        <i class="fas fa-plus me-2" style="margin: 8px;"></i> إضافة مستخدم
                    </a> -->
                </div>
            </div>
        </div>
                            ...
                            <tr class="user-row">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('Users.show', $rs->id) }}" class="action-btn view-btn"
                                            title="عرض التفاصيل">
                                        ...
                                        <form id="delete-form-{{ $rs->id }}"
                                            action="{{ route('Users.destroy', $rs->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
